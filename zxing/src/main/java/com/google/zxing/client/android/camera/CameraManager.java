...
public final class CameraManager {
    ...
    private static final int MAX_FRAME_WIDTH = 1080; //   扫码范围
    private static final int MAX_FRAME_HEIGHT = 1920; //  扫码范围
    ...
    public synchronized Rect getFramingRect() {
        if (framingRect == null) {
            ...
            Log.i(TAG, "screenResolution.x:" + screenResolution.x);//1080 1440
            Log.i(TAG, "screenResolution.y:" + screenResolution.y);//2250 2984
