...
public class CacheHelper {
    ...
    private final ConcurrentHashMap<String, SoftReference<Object>> mCache;
    private String mPrefFileName = "com.mango.mangomis";
...
//        this.mPrefFileName = mPrefFileName;
    ...
    private static CacheHelper init(Context context, String prefFileName){
    ...
    private <T> CacheHelper put(String key, T t){
        mCache.put(key, new SoftReference<>(t));
        SharedPreferences.Editor editor = getSharedPreferences().edit();
    ...
    {
        SoftReference<Object> reference = mCache.get(key);
        Object val;
    ...
    public static boolean containsKey(String key){
        return getInstance().containKey(key);
    }
